...
<body>
    ...
    <section class="container space pd-100-30">
        <aside id="side-menu">
            <h2>기준관리</h2>
            <h3 url="/html/criterion_department.html">부서 기준 관리</h3>
            <h3 url="/html/criterion_attendance.html">근태 기준 관리</h3>
            <h3 url="/html/criterion_payroll.html">급여 기준 관리</h3>
            <h2>인사관리</h2>
            <h3 url="/html/hr_department.html">부서 관리</h3>
            <h3 url="/html/hr_department_member.html">부서원 관리</h3>
            <h3 url="/html/hr_employee.html">사원 관리</h3>
            <h2>근태관리</h2>
            <h2>급여관리</h2>
        </aside>
